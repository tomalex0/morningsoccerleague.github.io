          ...
          <div className="mt-10 mx-auto max-w-7xl px-4 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                {/*  <Link*/}
                {/*    to="/seasons"*/}
                {/*    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 dark:bg-indigo-400 dark:text-gray-800"*/}
                {/*  >*/}
                {/*    Check Seasons*/}
                {/*  </Link>*/}
                {/*</div>*/}
                <Link
                  to="/seasons"
                  className="text-xl md:text-2xl font-medium  text-indigo-600 dark:text-indigo-400 hover:text-indigo-700"
                >
                  Check Seasons &rarr;
                </Link>
              </div>
